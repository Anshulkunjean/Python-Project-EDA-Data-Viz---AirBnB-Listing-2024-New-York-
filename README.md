...
1. Clone the repository: upload the .ipynb file
   ```
   git clone https://github.com/Anshulkunjean/Python-Project-EDA-Data-Viz---AirBnB-Listing-2024-New-York-?tab=readme-ov-file#contact
   ```
...
3. Run the **Jupyter notebook** or **Python script**:
   ```bash
   Google Colab EDA Project AirBnB.ipynb
   ```
...
- **GitHub**: [Your GitHub](https://github.com/Anshulkunjean)  
- **LinkedIn**: [Your LinkedIn](https://www.linkedin.com/in/anshul-maratha-740106212/)  
